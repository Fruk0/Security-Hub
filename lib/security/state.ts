...
export type UIAction =
  ...
  | { type: 'criteria/replaceBuffers'; answers: Record<string, QA>; justifications: Record<string, string> } // NUEVA
...
export function uiReducer(state: UIState, action: UIAction): UIState {
  switch (action.type) {
    ...
    case 'criteria/replaceBuffers': // NUEVA: reemplaza respuestas/justificaciones del criterio actual
      return {
        ...state,
        critAnswers: { ...action.answers },
        critJustifications: { ...action.justifications },
      }
...
export function createUIActions(dispatch: Dispatch<UIAction>) {
  return {
    ...
    replaceCriteriaBuffers: (answers: Record<string, QA>, justifications: Record<string, string>) =>
      dispatch({ type: 'criteria/replaceBuffers', answers, justifications }), // NUEVA
